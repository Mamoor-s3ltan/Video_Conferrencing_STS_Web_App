    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-700 via-purple-600 to-purple-800 text-white flex flex-col">
      ...
      <section id="features" className="bg-purple-800 py-16 px-8 md:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { title: "HD Video & Audio", desc: "Enjoy crystal-clear communication during meetings." },
            { title: "Real-time Translation", desc: "Break language barriers with live translation." },
            { title: "Secure & Reliable", desc: "Your data and privacy are fully protected." },
          ].map((feature, i) => (
            <div
              key={i}
